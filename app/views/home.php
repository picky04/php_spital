...
<div class="container">
    ...
    <?php if ($user['rol'] === 'admin'): ?>
        ...
        <button onclick="window.location.href='?route=create_medical_record'">Creare Fișă Medicală</button>
        <button onclick="window.location.href='?route=send_mail'">Trimite Email</button>
